...
program main
   ...
   do while (time < tend)
      ...
      if (size(swrm)<65536) then
         ...
         flag_2 = flag_2 + 1
         loc=1
         write(25,*) 65536-size(swrm), flag_2, time, loc
         write(*,*)'WARNING', 65536-size(swrm), 'particles lost at',time, 'yr after advection for the',flag_2, 'st time'
         close(25)
      endif
      ...
      if (size(swrm)<65536) then
         ...
         flag_3 = flag_3 + 1
         loc=2
         write(25,*) 65536-size(swrm), flag_3, time,loc
         write(*,*)'WARNING', 65536-size(swrm), 'particles lost at',time, 'yr after grid for the',flag_3, 'st time'
         close(25)
      endif
