...
| The details are ``mcdust`` are presented in  `Drążkowska et al 2013 <https://www.aanda.org/articles/aa/abs/2013/08/aa21566-13/aa21566-13.html>`_ & `Vaikundaraman et al. (in review in JOSS) <https://arxiv.org/abs/2507.21239>`_ . The code units are in cgs and we use a cylindrical coordinate system (r-z) in the code.
...
.. toctree::
    ...
    notebooks/kernel_tests.ipynb
    notebooks/verticalcolumn.ipynb
    example_1
    citation
